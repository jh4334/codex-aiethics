...
> 터치 기기에는 단축키가 없으므로, 위 모든 기능을 **X(메뉴) 버튼 → 메뉴**에서 열 수 있습니다.
...
src/game.js       게임 엔진 (이동·대화·배틀·회피·도감·자비·4종 엔딩·슬롯·일지·복습·챌린지·도전과제·접근성·도움말)
tools/validate.js 데이터 검증 (맵 너비, 워프, 도달 가능성, 박자, 도감, 조사 지점)
tools/smoketest.js 플레이 경로 자동 테스트 (진엔딩까지 시뮬레이션, 142개 검사)
