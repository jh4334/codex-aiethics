...
깨우치면, 거점 가운데 **신호 탑터**가 열려 보스에 도전합니다.
...
거점에서 **서쪽 열사의 폐허**와 **동쪽 오아시스**의 수호자를 깨우치면
가운데 **심판의 신전**이 열립니다.
...
보정됩니다. (특정 **주제만** 연습시키려면 「퀴즈 챌린지」에서 주제를 고르세요.)
...
tools/smoketest.js 플레이 경로 자동 테스트 (진엔딩까지 시뮬레이션, 322개 검사)
...
npm test               # 게임 로직 스모크 322개 + 세이브 슬롯 24개 검사
